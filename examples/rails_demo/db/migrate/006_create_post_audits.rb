...
class CreatePostAudits < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :post_audits, [:auditable_type, :auditable_id]
    add_index :post_audits, [:user_type, :user_id]
    add_index :post_audits, :request_uuid
  end
end
